...
import 'package:food/src/models/restaurant.dart';
                ...
                children: <Widget>[
                  ...
                  Positioned.fill(
                      ...
                      child: Align(
                          ...
                          child: Text(restaurantModel.name, style: TextStyle(color: white,fontSize: 26)))),
                  // average price
                  Positioned.fill(
                      bottom: 40,
                      child: Align(
                          alignment: Alignment.bottomCenter,
                          child: Text("Average Price: \$" + restaurantModel.avgPrice.toString(), style: TextStyle(color: white,fontSize: 18),))),
...
//              open & book section
              Row(
                ...
                children: <Widget>[
                  Text("Open", style:TextStyle(color: Colors.green,fontSize: 18)),
                  Container(
